...
module BlazorSurveyJs {
    ...
    //export function injectScripts(src: string[]) {
    ...
    //export function clearInjectedScripts() {
    ...
    //export async function checkJqueryAsync() {
    ...
    //export async function checkJquerySurveyAsync() {
    //    console.log("checkJquerySurveyAsync...");

    //    while (typeof (jQuery.fn as any).Survey === 'undefined') {
    //        await delayAsync();
    //    }
    ...
    //export async function checkKnockoutJsAsync() {
    ...
    //export async function checkSurveyCreatorJsAsync() {
